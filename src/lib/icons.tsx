...
export const NAV_ICONS = {
  ...
  pedidos:          '<rect x="3" y="8" width="18" height="13" rx="2"/><path d="M3 8l3-5h12l3 5"/><circle cx="12" cy="14" r="2"/>',
  ordenesDeTrabajo: '<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3-3a1 1 0 0 0-1.4-1.4l-2.3 2.3-.9-.9a1 1 0 0 0-1.4 0z"/><path d="M8 6H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-3.5"/>',
} as const;
...
export const NAV_ITEMS: { id: NavId; label: string; badge?: boolean }[] = [
  ...
  { id: 'ordenesDeTrabajo',   label: 'Órdenes de Trabajo' },
